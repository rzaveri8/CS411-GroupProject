...
/*var Linkedin = require('node-linkedin')('78cqng6qn9sp48', 'secret'); // Get app-id + secret from your LinkedIn developer account

var linkedin = Linkedin.init(this.token); // this.token = client token.

Linkedin.auth.setCallback('https://www.getpostman.com/oauth2/callback');
...
var APIKey = "78cqng6qn9sp48";
var APIKeySecret = "t9eT5zgW2uQmTS8D";
var callbackURL = "https://www.getpostman.com/oauth2/callback";
var APIVersion = "v1";
